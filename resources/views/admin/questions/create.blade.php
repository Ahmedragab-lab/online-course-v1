                ...
                <form method="post" action="{{ route('question.store') }}" autocomplete="off">
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group{{ $errors->has('score') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="score" id="input-score" class="form-control form-control-alternative{{ $errors->has('score') ? ' is-invalid' : '' }}" placeholder="{{ __('score') }}" value="{{ old('score') }}" required autofocus>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success mt-4" name="click">{{ __('Add') }}</button>
                        </div>
                    </div>
